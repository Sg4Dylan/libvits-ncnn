...
private:
    ...
    static bool
    load_model(const std::string &folder, Net &net, const std::string &name, bool multi, const Option &opt);
...
public:
    ...
    bool init(const std::string &model_folder, bool voice_convert, bool multi, const int n_vocab, Option &opt);
