...
Mat pad(const Mat& blob, int pad_top, int pad_bottom, int pad_left, int pad_right, float pad_value, const Option& opt); // �����Ҳ����
...
Mat softmax(const Mat &m, const Option &opt); // ������softmax
